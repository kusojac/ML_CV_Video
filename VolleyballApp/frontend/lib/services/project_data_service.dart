...
class ProjectDataService {
  ...
  Future<void> _loadData() async {
    try {
      ...
      if (await pFile.exists()) {
        ...
        final List<dynamic> jsonList = await compute((String c) => jsonDecode(c) as List<dynamic>, contents); // ⚡ Bolt Optimization: Offloaded JSON operations to background isolate using compute()
        _projects = jsonList
  ...
  Future<void> _saveData() async {
    try {
      ...
      ); // ⚡ Bolt Optimization: Offloaded JSON operations to background isolate using compute()
